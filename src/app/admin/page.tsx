...
export default function AdminDashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex">
            {/* Admin Sidebar */}
            <aside className="w-72 bg-slate-900 border-r border-white/5 flex flex-col sticky top-0 h-screen hidden lg:flex">
                <div className="p-8 border-b border-white/5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-white font-black tracking-tight leading-none">Admin Panel</h2>
                            <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mt-1">Management Suite</p>
                        </div>
                    </div>
                </div>

                <nav className="flex-1 p-6 space-y-2">
                    <Link href="/admin" className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/10 text-white font-black text-sm">
                        <BarChart3 size={20} className="text-blue-400" /> Dashboard
                    </Link>
                    <Link href="/admin/management?tab=companies" className="flex items-center gap-3 px-6 py-4 rounded-2xl text-slate-400 hover:text-white hover:bg-white/5 font-black text-sm transition-all">
                        <Building2 size={20} /> Companies
                    </Link>
                    <Link href="/admin/management?tab=jobs" className="flex items-center gap-3 px-6 py-4 rounded-2xl text-slate-400 hover:text-white hover:bg-white/5 font-black text-sm transition-all">
                        <Briefcase size={20} /> Jobs & Quests
                    </Link>
                    <Link href="/admin/management?tab=learning" className="flex items-center gap-3 px-6 py-4 rounded-2xl text-slate-400 hover:text-white hover:bg-white/5 font-black text-sm transition-all">
                        <GraduationCap size={20} /> E-Learning
                    </Link>
                </nav>

                <div className="p-6 border-t border-white/5">
                    <Link href="/" className="flex items-center justify-center gap-2 w-full py-4 bg-white/5 hover:bg-white/10 text-white font-black text-sm rounded-2xl transition-all">
                        サイトに戻る <ArrowUpRight size={18} />
                    </Link>
                </div>
            </aside>
            ...
            <main className="flex-1 flex flex-col min-w-0">
                <header className="bg-white border-b border-slate-200 h-20 sticky top-0 z-30 flex items-center justify-between px-8">
