...
export default function MomRegistration() {
    ...
    const handleComplete = () => {
        ...
        toast.success('登録が完了しました！あなたにぴったりの情報を表示します。');
        ...
        <div className="min-h-screen bg-[#FFFBF0] flex flex-col">
            ...
            <footer className="p-6 bg-white border-t border-pink-50">
                <button
                    ...
                    className="w-full bg-pink-500 hover:bg-pink-600 text-white font-black py-5 rounded-[2rem] shadow-xl shadow-pink-200 transition-all flex items-center justify-center gap-2 group active:scale-95"
                >
                    {step === 3 ? '登録を完了する' : '次へ進む'}
